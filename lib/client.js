...
Client.prototype.getVersion = function(callback, opt_timeout) {
  return this.connection.get("/version", callback, opt_timeout);
};
...
Client.prototype.getVersionCluster = function(callback, opt_timeout) {
  return this.connection.get("/version/cluster", callback, opt_timeout);
};
...
Client.prototype.getStatusCluster = function(callback, opt_timeout) {
  return this.connection.get("/status/cluster", callback, opt_timeout);
};
...
Client.prototype.getTables = function(callback, opt_timeout) {
  return this.connection.get("/", function(err, data, opt_timeout) {
