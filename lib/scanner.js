...
Scanner.prototype.create = function(params, callback, opt_timeout) {
  ...
  if (params.filter) {
    encode = function(obj) {
      ...
      for (k in obj) {
        if (k === "value" && (!obj["type"] ||
            obj["type"] !== "RegexStringComparator" &&
                obj["type"] !== "PageFilter")) {
  ...
  return this.client.connection.put(key, params,
...
Scanner.prototype.get = function(callback, opt_timeout) {
  var key, self;
  self = this;
...
Scanner.prototype["continue"] = function(opt_timeout) {
  return this.get(opt_timeout);
};
...
Scanner.prototype["delete"] = function(callback, opt_timeout) {
  var key, self;
  self = this;
  key = "/" + this.table + "/scanner/" + this.id;
